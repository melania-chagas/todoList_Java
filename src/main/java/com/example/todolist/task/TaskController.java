...
public class TaskController {
    ...
    @PostMapping("/")
    public ResponseEntity createNewTask(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        var idUser = request.getAttribute("idUser");
        taskModel.setIdUser((UUID)idUser);

        // Verifica se as datas das tasks fazem sentido.
    ...
    @GetMapping("/")
    public List<TaskModel> getTaskByIdUser(HttpServletRequest request) {
        var idUser = request.getAttribute("idUser");
